...
Friend Class frmDepartment
    ...
    Private Sub frmDepartment_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Call FillListview("SELECT * FROM tblMst_Department ORDER BY DepartmentCode ASC ", lvList)
        ...
        Select Case srcPerformWhat
            ...
            Case "Save"
                ...
                If State = FormState.AddStateMode Then
                    PK = GenerateNewIDNumber("tblMst_Department", "DepartmentCode")

                    sSQL = "INSERT INTO tblMst_Department"
            ...
            Case "Delete"
                ...
                If MsgBox("Are you sure you want to delete selected record? <Y/N>", MsgBoxStyle.Critical + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    Call DeleteSQL("tblMst_Department", "DepartmentCode", True, "", PK)
                Else
                    Exit Sub
                End If
...
ErrHandler: MsgBox(Err.Description, vbExclamation)
    ...
    Public Sub FillFormView(ByVal p_k As Double)
        ...
        Dim SQLCmd As New SqlCommand("SELECT * FROM tblMst_Department WHERE DepartmentCode=" & toNumber(p_k), MyConn)
        ...
        If Dtrdr.Read = False Then
            Exit Sub
        Else
            PK = Dtrdr.Item("DepartmentCode").ToString

            txtID.Text = Dtrdr.Item("DepartmentCode").ToString
...
ErrHandler:
    ...
    Private Sub FillListview(ByVal sSQL As String, ByRef srcListview As ListView)
        ...
        Do While Dtrdr.Read()
            Dim lv As ListViewItem = srcListview.Items.Add(Dtrdr.Item("DepartmentCode").ToString())
...
Mars:   MsgBox(Err.Description, MsgBoxStyle.Critical)
    ...
    Private Sub frmDepartment_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
    ...
    Private Sub btnFind_Click(sender As Object, e As EventArgs) Handles btnFind.Click
        ...
        If txtFind.Text = "" Then
            Call FillListview("SELECT * FROM tblMst_Department ORDER BY DepartmentCode ASC ", lvList)
        Else
            Call FillListview("SELECT * FROM tblMst_Department WHERE " &
                          " Description LIKE '%" & sqlSafe(txtFind.Text) & "%' " &
                          " OR Remarks LIKE '%" & sqlSafe(txtFind.Text) & "%'", lvList)
        End If
        Exit Sub
ErrFinder:
        MsgBox(Err.Description, MsgBoxStyle.Critical)
