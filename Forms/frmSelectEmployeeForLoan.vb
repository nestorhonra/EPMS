...
Public Class frmSelectEmployeeForLoan
    Dim PK As Double
    Private Sub frmSelectEmployeeForLoan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
ErrHandler:
    ...
    Private Sub frmSelectEmployeeForLoan_Resize(sender As Object, e As EventArgs) Handles Me.Resize
    ...
    Private Sub frmSelectEmployeeForLoan_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
