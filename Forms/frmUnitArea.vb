...
Friend Class frmUnitArea
    ...
    Dim sSQL As String
    Private Sub frmUnitArea_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Call FillListview("SELECT * FROM tblMst_Unit ORDER BY UnitCode ASC ", lvList)
        ...
        Select Case srcPerformWhat
            ...
            Case "Save"
                ...
                If State = FormState.AddStateMode Then
                    PK = GenerateNewIDNumber("tblMst_Unit", "UnitCode")

                    sSQL = "INSERT INTO tblMst_Unit"
                    sSQL = sSQL & "(UnitCode"
                ...
                ElseIf State = FormState.EditStateMode Then
                    ...
                    sSQL = sSQL & " WHERE UnitCode = " & toNumber(PK)
                End If
            ...
            Case "Delete"
                ...
                If MsgBox("Are you sure you want to delete selected record? <Y/N>", MsgBoxStyle.Critical + MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                    Call DeleteSQL("tblMst_Unit", "UnitCode", True, "", PK)
                Else
                    Exit Sub
                End If
...
ErrHandler: MsgBox(Err.Description, vbExclamation)
    ...
    Public Sub FillFormView(ByVal p_k As Double)
        ...
        Dim SQLCmd As New SqlCommand("SELECT * FROM tblMst_Unit WHERE UnitCode=" & toNumber(p_k), MyConn)
        ...
        If Dtrdr.Read = False Then
            Exit Sub
        Else
            PK = Dtrdr.Item("UnitCode").ToString

            txtID.Text = Dtrdr.Item("UnitCode").ToString
...
Mars:   MsgBox(Err.Description, MsgBoxStyle.Critical)
    ...
    Private Sub btnFind_Click(sender As Object, e As EventArgs) Handles btnFind.Click
        ...
        If txtFind.Text = "" Then
            Call FillListview("SELECT * FROM tblMst_Unit ORDER BY UnitCode ASC ", lvList)
        Else
            Call FillListview("SELECT * FROM tblMst_Unit WHERE " &
...
ErrFinder:
    ...
    Private Sub frmUnitArea_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Me.Dispose()
    End Sub
End Class